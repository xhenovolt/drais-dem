...
export async function GET(
  ...
  try {
    ...
    const isValid = await verifyWebAuthnCredential((fingerprint[0] as any).credential, challenge);
...
export async function POST(
  ...
  try {
    ...
    const isValid = await verifyWebAuthnCredential((storedFingerprint[0] as any).credential, credential);
